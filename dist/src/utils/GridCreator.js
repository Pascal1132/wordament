...
class GridCreator {
     ...
     */
    static getWeightedRandomLetter() {
...
GridCreator.LETTER_FREQUENCIES = {
    'E': 14.7,
    'A': 7.6,
    'I': 7.5,
    'S': 7.9,
...
GridCreator.LETTERS = Object.keys(GridCreator.LETTER_FREQUENCIES);
GridCreator.TOTAL_WEIGHT = Object.values(GridCreator.LETTER_FREQUENCIES).reduce((a, b) => a + b, 0);
exports.default = GridCreator;
